...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static final String INTENT_ASPECT_RATION_X = "aspect_ration_x";
    public static final String INTENT_ASPECT_RATION_Y = "aspect_ration_y";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent == null){
            showMessage(getString(R.string.toast_image_intent_null));
            return;
        }


        ASPECT_RATIO_X = intent.getIntExtra(INTENT_ASPECT_RATION_X, ASPECT_RATIO_X);
        ASPECT_RATIO_Y = intent.getIntExtra(INTENT_ASPECT_RATION_Y, ASPECT_RATIO_Y);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        switch (requestCode){
            ...
            case UCrop.RESULT_ERROR:
                ...
                Log.e(TAG, "onActivityResult: Crop Error", cropError);
                setResultCancelled();
                break;
    ...
    private String queryName(ContentResolver contentResolver, Uri imageUri) {
        Cursor returnCursor = contentResolver.query(imageUri, null, null, null, null);
    ...
    public void setResultOk(Uri imagePth){
        Intent intent = new Intent();
        intent.putExtra("path", imagePth);
